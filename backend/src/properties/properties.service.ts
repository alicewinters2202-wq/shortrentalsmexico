...
pricePerMonth: (o.pricePerMonth !== undefined && o.pricePerMonth !== null) ? o.pricePerMonth : p.pricePerMonth,
   ...
   * (before Lope de Vega / Moliere were added), so every EXISTING property
   * keeps exactly the availability state it had before, permanently -- it
   * will never re-randomize again, no matter what gets added elsewhere.
   * Keyed by cityFolder#folderNumber (stable, never changes). Properties
   * not found here (added after this snapshot) use live computation.
   */
  private readonly FROZEN_AVAILABILITY: Record<string, {
    ...
    'Cancun Quintana Roo#5': { available: false, availableFrom: '2026-04-25', occupiedSince: '2025-11-17', minStay: 10 },
    'Cancun Quintana Roo#6': { available: false, availableFrom: '2026-06-09', occupiedSince: '2026-03-19', minStay: 10 },
    'Cancun Quintana Roo#7': { available: false, availableFrom: '2026-07-23', occupiedSince: '2026-02-26', minStay: 10 },
    'Cancun Quintana Roo#8': { available: true, availableFrom: null, occupiedSince: null, minStay: 10 },
    'Cancun Quintana Roo#9': { available: false, availableFrom: '2026-10-19', occupiedSince: '2026-01-15', minStay: 10 },
    'Cancun Quintana Roo#10': { available: false, availableFrom: '2026-05-21', occupiedSince: '2025-12-25', minStay: 10 },
    'Cancun Quintana Roo#11': { available: false, availableFrom: '2026-07-04', occupiedSince: '2025-12-04', minStay: 10 },
    'Cancun Quintana Roo#12': { available: true, availableFrom: null, occupiedSince: null, minStay: 10 },
    'Cancun Quintana Roo#13': { available: false, availableFrom: '2026-09-30', occupiedSince: '2026-03-15', minStay: 10 },
    'Cancun Quintana Roo#14': { available: false, availableFrom: '2026-05-02', occupiedSince: '2026-02-22', minStay: 10 },
    'Chalapa Jalisco#2': { available: false, availableFrom: '2026-06-15', occupiedSince: '2026-02-01', minStay: 10 },
    'Chalapa Jalisco#3': { available: false, availableFrom: '2026-07-29', occupiedSince: '2026-01-10', minStay: 10 },
    'Chalapa Jalisco#4': { available: false, availableFrom: '2026-09-11', occupiedSince: '2025-12-20', minStay: 10 },
    'Chalapa Jalisco#5': { available: false, availableFrom: '2026-10-25', occupiedSince: '2025-11-29', minStay: 10 },
    'Chalapa Jalisco#6': { available: true, availableFrom: null, occupiedSince: null, minStay: 10 },
    'Chalapa Jalisco#7': { available: false, availableFrom: '2026-07-10', occupiedSince: '2026-03-10', minStay: 10 },
    'Chalapa Jalisco#8': { available: false, availableFrom: '2026-08-23', occupiedSince: '2026-02-17', minStay: 10 },
    'Chalapa Jalisco#9': { available: false, availableFrom: '2026-10-06', occupiedSince: '2026-01-27', minStay: 10 },
    'Guadalajara#2': { available: false, availableFrom: '2026-05-09', occupiedSince: '2026-01-06', minStay: 10 },
    'Guadalajara#3': { available: true, availableFrom: null, occupiedSince: null, minStay: 10 },
    'Guadalajara#4': { available: false, availableFrom: '2026-08-05', occupiedSince: '2025-11-25', minStay: 10 },
    'Guadalajara#5': { available: false, availableFrom: '2026-09-18', occupiedSince: '2026-03-26', minStay: 10 },
    'Guadalajara#6': { available: false, availableFrom: '2026-04-20', occupiedSince: '2026-03-05', minStay: 10 },
    'Guadalajara#7': { available: false, availableFrom: '2026-06-03', occupiedSince: '2026-02-12', minStay: 10 },
    'Guadalajara#8': { available: true, availableFrom: null, occupiedSince: null, minStay: 10 },
    'Guadalajara#9': { available: false, availableFrom: '2026-08-30', occupiedSince: '2026-01-01', minStay: 10 },
    'Guadalajara#10': { available: false, availableFrom: '2026-10-13', occupiedSince: '2025-12-11', minStay: 30 },
    'Guadalajara#11': { available: true, availableFrom: null, occupiedSince: null, minStay: 10 },
    'Guadalajara#12': { available: false, availableFrom: '2026-06-28', occupiedSince: '2026-03-22', minStay: 30 },
    'Guadalajara#13': { available: false, availableFrom: '2026-08-11', occupiedSince: '2026-03-01', minStay: 30 },
    'Guanajuato#2': { available: true, availableFrom: null, occupiedSince: null, minStay: 10 },
    'Guanajuato#3': { available: false, availableFrom: '2026-04-26', occupiedSince: '2026-01-18', minStay: 30 },
    'Guanajuato#4': { available: false, availableFrom: '2026-06-09', occupiedSince: '2025-12-27', minStay: 30 },
    'Guanajuato#5': { available: false, availableFrom: '2026-07-23', occupiedSince: '2025-12-06', minStay: 30 },
    'Guanajuato#6': { available: false, availableFrom: '2026-09-06', occupiedSince: '2025-11-15', minStay: 14 },
    'Guanajuato#7': { available: true, availableFrom: null, occupiedSince: null, minStay: 14 },
    'Guanajuato#8': { available: false, availableFrom: '2026-05-22', occupiedSince: '2026-02-24', minStay: 14 },
    'Guanajuato#9': { available: false, availableFrom: '2026-07-05', occupiedSince: '2026-02-03', minStay: 14 },
    'Guanajuato#10': { available: false, availableFrom: '2026-08-18', occupiedSince: '2026-01-13', minStay: 14 },
    'Guanajuato#11': { available: false, availableFrom: '2026-10-01', occupiedSince: '2025-12-23', minStay: 14 },
    ...
    'Merida Yucatan#2': { available: false, availableFrom: '2026-09-12', occupiedSince: '2026-02-19', minStay: 14 },
    'Merida Yucatan#3': { available: false, availableFrom: '2026-10-26', occupiedSince: '2026-01-29', minStay: 14 },
    'Merida Yucatan#4': { available: false, availableFrom: '2026-05-28', occupiedSince: '2026-01-08', minStay: 14 },
    'Merida Yucatan#5': { available: true, availableFrom: null, occupiedSince: null, minStay: 14 },
    'Merida Yucatan#6': { available: false, availableFrom: '2026-08-24', occupiedSince: '2025-11-27', minStay: 14 },
    'Merida Yucatan#7': { available: false, availableFrom: '2026-10-07', occupiedSince: '2025-11-06', minStay: 14 },
    'Merida Yucatan#8': { available: false, availableFrom: '2026-05-09', occupiedSince: '2026-03-08', minStay: 14 },
    'Merida Yucatan#9': { available: false, availableFrom: '2026-06-23', occupiedSince: '2026-02-15', minStay: 14 },
    'Merida Yucatan#10': { available: true, availableFrom: null, occupiedSince: null, minStay: 14 },
    'Merida Yucatan#11': { available: false, availableFrom: '2026-09-19', occupiedSince: '2026-01-04', minStay: 14 },
    'Merida Yucatan#12': { available: false, availableFrom: '2026-04-21', occupiedSince: '2025-12-13', minStay: 14 },
    'Merida Yucatan#13': { available: false, availableFrom: '2026-06-04', occupiedSince: '2025-11-22', minStay: 14 },
    'Merida Yucatan#14': { available: false, availableFrom: '2026-07-18', occupiedSince: '2026-03-24', minStay: 14 },
    'Merida Yucatan#15': { available: true, availableFrom: null, occupiedSince: null, minStay: 14 },
    'Merida Yucatan#16': { available: false, availableFrom: '2026-10-14', occupiedSince: '2026-02-10', minStay: 14 },
    'Merida Yucatan#17': { available: false, availableFrom: '2026-05-16', occupiedSince: '2026-01-20', minStay: 14 },
    'Monterrey#2': { available: false, availableFrom: '2026-06-29', occupiedSince: '2025-12-30', minStay: 10 },
    'Monterrey#3': { available: false, availableFrom: '2026-08-12', occupiedSince: '2025-12-09', minStay: 10 },
    'Monterrey#4': { available: false, availableFrom: '2026-09-25', occupiedSince: '2025-11-18', minStay: 10 },
    'Monterrey#5': { available: true, availableFrom: null, occupiedSince: null, minStay: 10 },
    'Monterrey#6': { available: false, availableFrom: '2026-06-10', occupiedSince: '2026-02-27', minStay: 10 },
    'Monterrey#7': { available: false, availableFrom: '2026-07-24', occupiedSince: '2026-02-05', minStay: 10 },
    'Monterrey#8': { available: false, availableFrom: '2026-09-06', occupiedSince: '2026-01-15', minStay: 10 },
    'Monterrey#9': { available: false, availableFrom: '2026-10-21', occupiedSince: '2025-12-25', minStay: 10 },
    'Monterrey#10': { available: true, availableFrom: null, occupiedSince: null, minStay: 10 },
    'Monterrey#11': { available: false, availableFrom: '2026-07-06', occupiedSince: '2025-11-13', minStay: 10 },
    'Monterrey#12': { available: false, availableFrom: '2026-08-19', occupiedSince: '2026-03-15', minStay: 10 },
    'Monterrey#13': { available: false, availableFrom: '2026-10-02', occupiedSince: '2026-02-22', minStay: 10 },
    'Monterrey#14': { available: false, availableFrom: '2026-05-04', occupiedSince: '2026-02-01', minStay: 10 },
    'Nuevo Vallarta#2': { available: true, availableFrom: null, occupiedSince: null, minStay: 10 },
    'Nuevo Vallarta#3': { available: false, availableFrom: '2026-07-31', occupiedSince: '2025-12-21', minStay: 10 },
    'Nuevo Vallarta#4': { available: false, availableFrom: '2026-09-13', occupiedSince: '2025-11-30', minStay: 10 },
    'Nuevo Vallarta#5': { available: false, availableFrom: '2026-10-27', occupiedSince: '2025-11-08', minStay: 10 },
    'Nuevo Vallarta#6': { available: false, availableFrom: '2026-05-29', occupiedSince: '2026-03-10', minStay: 10 },
    'Nuevo Vallarta#7': { available: false, availableFrom: '2026-07-12', occupiedSince: '2026-02-17', minStay: 10 },
    'Nuevo Vallarta#8': { available: false, availableFrom: '2026-08-25', occupiedSince: '2026-01-27', minStay: 10 },
    'Nuevo Vallarta#9': { available: false, availableFrom: '2026-10-08', occupiedSince: '2026-01-06', minStay: 10 },
    'Nuevo Vallarta#10': { available: false, availableFrom: '2026-05-10', occupiedSince: '2025-12-16', minStay: 10 },
    'Nuevo Vallarta#11': { available: false, availableFrom: '2026-06-23', occupiedSince: '2025-11-25', minStay: 10 },
    'Nuevo Vallarta#12': { available: false, availableFrom: '2026-08-06', occupiedSince: '2025-11-04', minStay: 10 },
    'Nuevo Vallarta#13': { available: true, availableFrom: null, occupiedSince: null, minStay: 10 },
    'Nuevo Vallarta#14': { available: false, availableFrom: '2026-04-22', occupiedSince: '2026-02-13', minStay: 10 },
    'Nuevo Vallarta#15': { available: false, availableFrom: '2026-06-05', occupiedSince: '2026-01-23', minStay: 10 },
    'Nuevo Vallarta#16': { available: false, availableFrom: '2026-07-19', occupiedSince: '2026-01-01', minStay: 10 },
    'Nuevo Vallarta#17': { available: false, availableFrom: '2026-09-01', occupiedSince: '2025-12-11', minStay: 10 },
    'Nuevo Vallarta#18': { available: true, availableFrom: null, occupiedSince: null, minStay: 10 },
    'Nuevo Vallarta#19': { available: false, availableFrom: '2026-05-17', occupiedSince: '2026-03-22', minStay: 10 },
    'Nuevo Vallarta#20': { available: false, availableFrom: '2026-06-30', occupiedSince: '2026-03-01', minStay: 10 },
    'Nuevo Vallarta#21': { available: false, availableFrom: '2026-08-13', occupiedSince: '2026-02-08', minStay: 10 },
    'Nuevo Vallarta#22': { available: false, availableFrom: '2026-09-26', occupiedSince: '2026-01-18', minStay: 10 },
    'Playa del Carmen#2': { available: false, availableFrom: '2026-04-28', occupiedSince: '2025-12-28', minStay: 10 },
    'Playa del Carmen#3': { available: false, availableFrom: '2026-06-11', occupiedSince: '2025-12-07', minStay: 10 },
    'Playa del Carmen#4': { available: false, availableFrom: '2026-07-25', occupiedSince: '2025-11-16', minStay: 10 },
    'Playa del Carmen#5': { available: false, availableFrom: '2026-09-07', occupiedSince: '2026-03-17', minStay: 10 },
    'Playa del Carmen#6': { available: false, availableFrom: '2026-10-21', occupiedSince: '2026-02-24', minStay: 10 },
    'Playa del Carmen#7': { available: false, availableFrom: '2026-05-23', occupiedSince: '2026-02-03', minStay: 10 },
    'Playa del Carmen#8': { available: true, availableFrom: null, occupiedSince: null, minStay: 10 },
    'Playa del Carmen#9': { available: false, availableFrom: '2026-08-20', occupiedSince: '2025-12-23', minStay: 10 },
    'Playa del Carmen#10': { available: false, availableFrom: '2026-10-03', occupiedSince: '2025-12-02', minStay: 10 },
    'Playa del Carmen#11': { available: false, availableFrom: '2026-05-05', occupiedSince: '2025-11-11', minStay: 10 },
    ...
    'Puerto Vallarta Jalisco#4': { available: false, availableFrom: '2026-09-14', occupiedSince: '2026-01-30', minStay: 10 },
    'Puerto Vallarta Jalisco#5': { available: false, availableFrom: '2026-10-28', occupiedSince: '2026-01-09', minStay: 10 },
    'Puerto Vallarta Jalisco#6': { available: false, availableFrom: '2026-05-30', occupiedSince: '2025-12-18', minStay: 10 },
    'Puerto Vallarta Jalisco#7': { available: false, availableFrom: '2026-07-13', occupiedSince: '2025-11-27', minStay: 10 },
    ...
    'Puerto Vallarta Jalisco#10': { available: false, availableFrom: '2026-05-11', occupiedSince: '2026-02-15', minStay: 30 },
    ...
    'Puerto Vallarta Jalisco#17': { available: false, availableFrom: '2026-09-02', occupiedSince: '2026-02-10', minStay: 14 },
    'Puerto Vallarta Jalisco#18': { available: false, availableFrom: '2026-10-16', occupiedSince: '2026-01-20', minStay: 14 },
    'Puerto Vallarta Jalisco#19': { available: true, availableFrom: null, occupiedSince: null, minStay: 14 },
    'Puerto Vallarta Jalisco#20': { available: false, availableFrom: '2026-07-01', occupiedSince: '2025-12-09', minStay: 14 },
    'Puerto Vallarta Jalisco#21': { available: false, availableFrom: '2026-08-14', occupiedSince: '2025-11-18', minStay: 14 },
    'Puerto Vallarta Jalisco#22': { available: false, availableFrom: '2026-09-27', occupiedSince: '2026-03-20', minStay: 14 },
    ...
    'Santiago Nuevo Leon#3': { available: false, availableFrom: '2026-07-26', occupiedSince: '2026-01-16', minStay: 14 },
    'Tulum Quintana Roo#2': { available: false, availableFrom: '2026-09-08', occupiedSince: '2025-12-26', minStay: 14 },
    'Tulum Quintana Roo#3': { available: false, availableFrom: '2026-10-22', occupiedSince: '2025-12-04', minStay: 14 },
    'Tulum Quintana Roo#4': { available: false, availableFrom: '2026-05-24', occupiedSince: '2025-11-13', minStay: 14 },
    'Tulum Quintana Roo#5': { available: false, availableFrom: '2026-07-07', occupiedSince: '2026-03-15', minStay: 14 },
    'Tulum Quintana Roo#6': { available: true, availableFrom: null, occupiedSince: null, minStay: 14 },
    'Tulum Quintana Roo#7': { available: false, availableFrom: '2026-10-04', occupiedSince: '2026-02-01', minStay: 14 },
    'Tulum Quintana Roo#8': { available: false, availableFrom: '2026-05-06', occupiedSince: '2026-01-11', minStay: 14 },
    'Tulum Quintana Roo#9': { available: false, availableFrom: '2026-06-19', occupiedSince: '2025-12-21', minStay: 14 },
    'Tulum Quintana Roo#10': { available: false, availableFrom: '2026-08-02', occupiedSince: '2025-11-30', minStay: 14 },
    'Tulum Quintana Roo#11': { available: true, availableFrom: null, occupiedSince: null, minStay: 14 },
    'Tulum Quintana Roo#12': { available: false, availableFrom: '2026-04-17', occupiedSince: '2026-03-11', minStay: 14 },
    'Tulum Quintana Roo#13': { available: false, availableFrom: '2026-05-31', occupiedSince: '2026-02-18', minStay: 14 },
    'Tulum Quintana Roo#14': { available: false, availableFrom: '2026-07-14', occupiedSince: '2026-01-27', minStay: 14 },
    'Tulum Quintana Roo#15': { available: false, availableFrom: '2026-08-27', occupiedSince: '2026-01-06', minStay: 14 },
    'Tulum Quintana Roo#16': { available: true, availableFrom: null, occupiedSince: null, minStay: 14 },
    'Tulum Quintana Roo#17': { available: false, availableFrom: '2026-05-12', occupiedSince: '2025-11-25', minStay: 10 },
    'Tulum Quintana Roo#18': { available: false, availableFrom: '2026-06-25', occupiedSince: '2025-11-04', minStay: 10 },
  };
