...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return {
    alternates: { canonical: `https://shortstaymx.com/properties/${property.slug}` },
            ...
            <div>
              ...
              <div className="rounded-2xl overflow-hidden" style={{ border: '1px solid var(--border)' }}>
                {property.lat !== null && property.lng !== null && cityMapPoints.length > 0 ? (
                  <PropertiesMap points={cityMapPoints} accentColor="var(--ochre)" highlightId={property.id} height={360} />
                ) : (
                  <iframe
                    src={mapsUrl}
                    width="100%"
