...
export const metadata = {
  ...
  description: "Departamentos amueblados en la Condesa, Ciudad de Mexico. Parques, restaurantes y vida tranquila en una de las colonias mas queridas de la capital.",
};
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="max-w-3xl mb-16">
          ...
          <p className="text-base leading-relaxed mb-4" style={{ color: "var(--muted)" }}>
            El famoso Parque Mexico y el Parque Espana son los pulmones de la colonia. La Avenida Amsterdam — una calle circular con camellones arbolados — es perfecta para correr, andar en bici o simplemente caminar. La Condesa tiene todo lo que necesitas a pie de calle.
          </p>
          <p className="text-base leading-relaxed" style={{ color: "var(--muted)" }}>
            <strong style={{ color: "var(--ink)" }}>Perfil del residente:</strong> Parejas jovenes, profesionales, nomadas digitales y familias pequenas que buscan tranquilidad y vida de barrio.
          </p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-16">
          {[
            { icon: "🌿", title: "Parque Mexico", desc: "Uno de los parques mas icónicos de CDMX a pasos de tu departamento" },
            { icon: "🚴", title: "Ciudad ciclista", desc: "Avenida Amsterdam y ciclovias hacen de la Condesa ideal para ciclistas" },
            { icon: "🍽️", title: "Gastronomia de nivel", desc: "Restaurantes premiados y cafes de especialidad en cada esquina" },
          ].map(r => (
        ...
        <h2 className="font-serif text-3xl mb-8" style={{ color: "var(--ink)" }}>Propiedades en Condesa</h2>
