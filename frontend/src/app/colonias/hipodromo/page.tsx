...
export const metadata = {
  ...
  description: "Departamentos amueblados en el Hipodromo y Hipodromo Condesa, Ciudad de Mexico. Zona tranquila con excelentes amenidades y acceso a Reforma.",
};
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="max-w-3xl mb-16">
          ...
          <p className="text-lg leading-relaxed mb-4" style={{ color: "var(--muted)" }}>
            El Hipodromo y el Hipodromo Condesa son colonias tranquilas y residenciales ubicadas entre la Condesa y la Roma. Su ambiente relajado, calles arboladas y excelente conectividad las hacen ideales para quienes buscan vivir en el corazon de CDMX sin el ruido del centro.
          </p>
          <p className="text-base leading-relaxed mb-4" style={{ color: "var(--muted)" }}>
            La zona cuenta con edificios modernos de lujo con amenidades completas — albercas, gimnasios, roof gardens — a precios mas accesibles que Polanco. Es perfecta para profesionales y familias que buscan calidad sin pagar de mas.
          </p>
          <p className="text-base leading-relaxed" style={{ color: "var(--muted)" }}>
            <strong style={{ color: "var(--ink)" }}>Perfil del residente:</strong> Profesionales jovenes, familias y expatriados que buscan calidad de vida y amenidades completas a buen precio.
          </p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-16">
          {[
            { icon: "🏊", title: "Amenidades completas", desc: "Edificios con alberca, gimnasio, roof garden y mas" },
            { icon: "🏙️", title: "Ubicacion central", desc: "A minutos de Reforma, Condesa, Roma y los principales centros de negocios" },
            { icon: "💰", title: "Mejor precio/calidad", desc: "Departamentos de lujo a precios mas accesibles que Polanco" },
          ].map(r => (
        ...
        <h2 className="font-serif text-3xl mb-8" style={{ color: "var(--ink)" }}>Propiedades en Hipodromo Condesa</h2>
