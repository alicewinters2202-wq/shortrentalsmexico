...
export async function generateMetadata() {
  ...
  return {
    ...
    title: es ? 'Sobre nosotros | ShortStayMX' : 'About us | ShortStayMX',
    description: es
      ? 'Conoce a ShortStayMX: hospitalidad profesional en los mejores destinos de México.'
      : 'Meet ShortStayMX: professional hospitality at the best destinations in Mexico.',
  };
}
