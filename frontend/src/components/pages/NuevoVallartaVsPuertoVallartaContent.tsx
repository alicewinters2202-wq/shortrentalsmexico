...
export const metadata = {
  alternates: { canonical: 'https://shortstaymx.com/blog/nuevo-vallarta-vs-puerto-vallarta' },
...
export default function NuevoVallartaVsPuertoVallartaContent({ lang }: { lang: 'es' | 'en' }) {
  const es = lang !== 'en';
