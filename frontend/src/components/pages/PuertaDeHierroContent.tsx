...
export const metadata = {
  alternates: { canonical: 'https://shortstaymx.com/colonias/guadalajara/puerta-de-hierro' },
...
export default async function PuertaDeHierroContent({ lang }: { lang: "es" | "en" }) {
  const es = lang !== "en";
    ...
    <div style={{ backgroundColor: "var(--cream)", minHeight: "100vh" }}>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="max-w-3xl mb-16">
          ...
          <h1 className="italic text-5xl sm:text-6xl mb-6" style={{ color: "var(--ink)", fontFamily: "var(--font-display), serif" }}>Puerta de Hierro</h1>
          <p className="text-lg leading-relaxed mb-4" style={{ color: "var(--muted)" }}>
            {es ? "Puerta de Hierro es la zona más exclusiva de Zapopan y una de las más prestigiosas de todo el area metropolitana de Guadalajara. Torres residenciales de lujo, el centro comercial Andares con las mejores tiendas internacionales, hospitales privados de primer nivel, colegios internacionales bilingues y una excelente conectividad hacen de esta zona la primera elección para ejecutivos corporativos, empresarios y familias que buscan lo mejor de Guadalajara." : "Puerta de Hierro is the most exclusive area of Zapopan and one of the most prestigious in the entire Guadalajara metropolitan area. Luxury residential towers, the Andares shopping center with the best international stores, top-tier private hospitals, bilingual international schools and excellent connectivity make this area the first choice for corporate executives, entrepreneurs and families seeking the best of Guadalajara."}
          </p>
          <p className="text-base leading-relaxed mb-4" style={{ color: "var(--muted)" }}>
            {es ? "El centro comercial Andares es el epicentro de la zona: con más de 300 tiendas incluyendo boutiques internacionales, los mejores restaurantes de Guadalajara y un ambiente de primer mundo. El Hospital Country 2000 y otros centros medicos privados de primer nivel estan a minutos. El aeropuerto internacional Miguel Hidalgo está a solo 15 minutos en coche." : "The Andares shopping center is the epicenter of the area: with more than 300 stores including international boutiques, the best restaurants in Guadalajara and a world-class atmosphere. Country 2000 Hospital and other top-tier private medical centers are minutes away. Miguel Hidalgo international airport is just 15 minutes by car."}
          </p>
          <p className="text-base leading-relaxed" style={{ color: "var(--muted)" }}>
            <strong style={{ color: "var(--ink)" }}>{es ? "Perfil del residente:" : "Resident profile:"}</strong>{" "}
            {es ? "Ejecutivos corporativos, empresarios, familias y expatriados que buscan lo mejor de Guadalajara en la zona más exclusiva de Zapopan." : "Corporate executives, entrepreneurs, families and expats seeking the best of Guadalajara in the most exclusive area of Zapopan."}
          </p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-16">
          {[
            { icon: "🏬", title_es: "Andares Shopping", title_en: "Andares Shopping", desc_es: "El centro comercial más exclusivo de Guadalajara con más de 300 tiendas y los mejores restaurantes", desc_en: "The most exclusive shopping center in Guadalajara with more than 300 stores and the best restaurants" },
            ...
            { icon: "🔒", title_es: "Zona segura", title_en: "Safe area", desc_es: "Una de las zonas más seguras y vigiladas de toda el area metropolitana de Guadalajara", desc_en: "One of the safest and most monitored areas in the entire Guadalajara metropolitan area" },
          ].map(r => (
        ...
        <div className="mt-12 p-6 rounded-2xl" style={{ backgroundColor: "var(--card)", border: "1px solid var(--border)" }}>
          <p className="text-sm mb-2" style={{ color: "var(--ink)" }}>{es ? "¿Quieres saber más sobre vivir en Guadalajara?" : "Want to know more about living in Guadalajara?"}</p>
