...
export default async function SanPedroContent({ lang }: { lang: "es" | "en" }) {
  const es = lang !== "en";
    ...
    <div style={{ backgroundColor: "var(--cream)", minHeight: "100vh" }}>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="max-w-3xl mb-16">
          ...
          <h1 className="italic text-5xl sm:text-6xl mb-6" style={{ color: "var(--ink)", fontFamily: "var(--font-display), serif" }}>San Pedro Garza García</h1>
