...
export default function WhatsAppButton() {
  ...
  const message = isEn
    ? 'Hi, I saw your website (ShortStayMX) and I would like information about your available properties.'
    : 'Hola, vi su pagina (ShortStayMX) y quisiera informacion sobre sus propiedades disponibles.';
