...
export default function WhyUs({ lang }: Props) {
  ...
  const reasons = [
    {
      icon: '📅',
      title: es ? 'Desde 2023' : 'Since 2023',
      desc: es
        ? 'Mas de 3 años conectando a inquilinos con las mejores propiedades amuebladas en México. Conocemos el mercado como nadie.'
        : 'Over 3 years connecting tenants with the best furnished properties in Mexico. We know the market like no one else.',
    },
    {
      icon: '💰',
  ...
  return (
    <section className="py-24 px-6" style={{ backgroundColor: 'var(--cream)' }}>
      <div className="max-w-7xl mx-auto">
        ...
        <h2 className="italic text-4xl sm:text-5xl mb-4" style={{ color: 'var(--ink)', fontFamily: 'var(--font-display), serif' }}>
