...
function buildWaMessage(agent: typeof AGENTS[0], quote: Quote, lang: 'es' | 'en') {
  const link = `https://temporaryrentalsmexico.com/properties/${quote.slug}`;
  if (lang === 'en') {
    return encodeURIComponent(
      `Hi, I'm contacting you from temporaryrentalsmexico.com. Hello ${agent.name}! I'm interested in the property ${link}\n\n` +
  ...
  return encodeURIComponent(
    `Hola, te contacto desde temporaryrentalsmexico.com. Hola ${agent.name}, me interesa la propiedad ${link}\n\n` +
