...
const T = {
  es: {
    ...
    taglineSub2: 'Cada propiedad en TemporaryRentalsMexico es verificada personalmente. Si la publicamos, es porque la habitaríamos nosotros mismos.',
    ...
    writeUs: 'Escribir →',
    cancellationPolicy: 'Cancela 15 días o más antes del check-in para un reembolso completo, o dentro de los 14 días para el 50%.',
    // agent modal
  ...
  en: {
    ...
    taglineSub2: 'Every property on TemporaryRentalsMexico is personally verified. If we list it, it\'s because we\'d stay there ourselves.',
    ...
    writeUs: 'Write →',
    cancellationPolicy: 'Cancel 15+ days before check-in for a full refund, or within 14 days for 50% back.',
