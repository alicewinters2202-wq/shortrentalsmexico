...
export const metadata = {
  title: "Rentas amuebladas en Polanco, CDMX | TemporaryRentalsMexico",
    ...
    <div style={{ backgroundColor: "var(--cream)", minHeight: "100vh" }}>
      <nav className="sticky top-0 z-40 backdrop-blur-md" style={{ backgroundColor: "rgba(28,28,30,0.9)", borderBottom: "1px solid var(--border)" }}>
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center gap-4">
          ...
          <Link href="/" className="font-serif font-medium" style={{ color: "var(--ink)" }}>TemporaryRentalsMexico</Link>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="max-w-3xl mb-16">
          ...
          <h1 className="italic text-5xl sm:text-6xl mb-6" style={{ color: "var(--ink)" }}>Polanco</h1>
