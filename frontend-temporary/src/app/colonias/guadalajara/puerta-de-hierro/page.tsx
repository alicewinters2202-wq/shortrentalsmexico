...
export const metadata = {
  alternates: { canonical: 'https://temporaryrentalsmexico.com/colonias/guadalajara/puerta-de-hierro' },
  title: "Furnished rentals in Puerta de Hierro, Guadalajara | TemporaryRentalsMexico",
