        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex justify-center">
            <WhatsAppLink href={`https://wa.me/5215643232610?text=${encodeURIComponent(
                lang === 'en'
                  ? "Hi, I saw your site, temporaryrentalsmexico.com, and I'd like help finding my ideal stay."
                  : 'Hola, vi su sitio, temporaryrentalsmexico.com, y me gustaría ayuda para encontrar mi estancia ideal.'
              )}`}
              source="homepage_cta"
              className="inline-flex items-center gap-3 px-8 py-4 rounded-full font-semibold text-sm text-white hover:opacity-90 hover:scale-[1.03] active:scale-[0.97] transition-all duration-200 bg-amber-500">
        ...
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="text-center sm:text-left">
            ...
            <p className="text-xs mt-0.5" style={{ color: 'var(--muted)' }}>
              © 2023–{new Date().getFullYear()} TemporaryRentalsMexico S.A. de C.V. · {t.footerTagline}
            </p>
          </div>
