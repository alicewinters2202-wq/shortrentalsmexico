      ...
      >
        ...
        <a
          href={`https://wa.me/525643232610?text=${encodeURIComponent(
            lang === 'en'
              ? `I'm interested in a long-term stay (3+ months) in the property https://temporaryrentalsmexico.com/properties/${property.slug}. Could you give me more information about special conditions?`
              : `Me interesa una estancia larga (más de 3 meses) en la propiedad https://temporaryrentalsmexico.com/properties/${property.slug}. ¿Me pueden dar información sobre las condiciones especiales?`
          )}`}
          target="_blank"
