    ...
    <div style={{ backgroundColor: 'var(--cream)', minHeight: '100vh' }}>
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <h1 className="italic text-4xl sm:text-5xl mb-6 leading-tight" style={{ color: 'var(--ink)' }}>
          {es ? 'Polanco vs Roma Norte: ¿Cuál es la mejor colonia para vivir en CDMX?' : 'Polanco vs Roma Norte: Which is the best neighborhood to live in México City?'}
        </h1>
        <div className="space-y-6">
          <p className="text-lg leading-relaxed" style={{ color: 'var(--muted)' }}>
            {es ? 'Si estás buscando rentar en Ciudad de México, es muy probable que Polanco y Roma Norte estén en tu lista de opciones. Ambas colonias son las favoritas de expatriados, nómadas digitales y ejecutivos internacionales — pero son muy diferentes entre sí. En este artículo te ayudamos a elegir cuál es la mejor para ti.' : 'If you are looking to rent in México City, Polanco and Roma Norte are probably on your list of options. Both neighborhoods are favorites among expats, digital nomads and international executives — but they are very different from each other. In this article we help you choose which one is best for you.'}
          </p>
          ...
          <p className="text-base leading-relaxed" style={{ color: 'var(--muted)' }}>
            {es ? 'Roma Norte es la colonia más vibrante y creativa de Ciudad de México. Con sus edificios art déco, calles arboladas, cafés de especialidad, galerías de arte y una escena gastronómica de primer nivel, es el hogar perfecto para creativos, artistas, nómadas digitales y jóvenes profesionales que valoran la cultura por encima de todo.' : 'Roma Norte is the most vibrant and creative neighborhood in México City. With its art deco buildings, tree-lined streets, specialty cafes, art galleries and a top-tier gastronomic scene, it is the perfect home for creatives, artists, digital nomads and young professionals who value culture above all.'}
          </p>
          <p className="text-base leading-relaxed" style={{ color: 'var(--muted)' }}>
          ...
          <p className="text-base leading-relaxed" style={{ color: 'var(--muted)' }}>
            {es ? 'La respuesta depende completamente de tu estilo de vida y prioridades. Si buscas exclusividad, seguridad máxima, estás en México por trabajo corporativo o diplomático, y no te importa pagar más por la comodidad, Polanco es tu colonia sin duda.' : 'The answer depends entirely on your lifestyle and priorities. If you seek exclusivity, maximum security, are in México for corporate or diplomatic work, and do not mind paying more for comfort, Polanco is definitely your neighborhood.'}
          </p>
          <p className="text-base leading-relaxed" style={{ color: 'var(--muted)' }}>
