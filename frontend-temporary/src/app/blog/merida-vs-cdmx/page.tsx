            ...
            <table className="w-full text-sm min-w-[480px]">
              ...
              <tbody>
                {[
                  ...
                  { aspect: es ? 'Seguridad' : 'Security', cdmx: es ? 'Variable por zona' : 'Varies by area', merida: es ? 'La más alta de México' : 'Highest in México' },
