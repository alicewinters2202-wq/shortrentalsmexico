    ...
    <div style={{ backgroundColor: 'var(--cream)', minHeight: '100vh' }}>
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-6">
          ...
          <p className="text-base leading-relaxed" style={{ color: 'var(--muted)' }}>
            {es ? 'Polanco concentra algunos de los mejores museos de México. El Museo Soumaya, con su icónica fachada plateada diseñada por el arquitecto Fernando Romero, alberga más de 66,000 obras de arte de todas las épocas. El Museo Jumex es uno de los museos de arte contemporáneo más importantes de América Latina. Y el Museo Nacional de Antropología, en el límite con Chapultepec, es considerado uno de los mejores del mundo.' : 'Polanco concentrates some of the best museums in México. The Soumaya Museum, with its iconic silver facade designed by architect Fernando Romero, houses more than 66,000 works of art from all periods. The Jumex Museum is one of the most important contemporary art museums in Latin America. And the National Museum of Anthropology, on the border with Chapultepec, is considered one of the best in the world.'}
          </p>
