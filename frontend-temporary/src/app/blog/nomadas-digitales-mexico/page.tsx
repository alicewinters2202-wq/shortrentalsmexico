    ...
    <div style={{ backgroundColor: 'var(--cream)', minHeight: '100vh' }}>
      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-6">
          ...
          <p className="text-base leading-relaxed" style={{ color: 'var(--muted)' }}>
            {es ? 'Antes de mudarte a México como nómada digital, ten en cuenta estos consejos. Primero, verifica siempre la velocidad de internet antes de confirmar un departamento. La mayoría de los propietarios en TemporaryRentalsMexico especifican la velocidad de WiFi. Segundo, considera usar un hotspot móvil como respaldo, especialmente en Tulum donde la conexión puede ser irregular.' : 'Before moving to México as a digital nomad, keep these tips in mind. First, always verify internet speed before confirming an apartment. Most landlords on TemporaryRentalsMexico specify WiFi speed. Second, consider using a mobile hotspot as backup, especially in Tulum where the connection can be irregular.'}
          </p>
