...
export default function ContactPage() {
  ...
  const handleSubmit = () => {
    ...
    const text = `Hola, me contacto desde TemporaryRentalsMexico.\n\nNombre: ${name}\nEmail: ${email}\nCiudad de interés: ${city}\nMensaje: ${message}`;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl p-6" style={{ backgroundColor: 'var(--card)', border: '1px solid var(--border)' }}>
              ...
              <a href="https://wa.me/525643232610?text=%5BTemporaryRentalsMexico%5D%20Hola%2C%20necesito%20ayuda%20para%20encontrar%20una%20propiedad%20en%20México."
