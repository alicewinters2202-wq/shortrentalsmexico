...
export default function ContactPage() {
  ...
  const handleSubmit = () => {
    ...
    const text = lang === 'en'
      ? `Hi, I saw your site, temporaryrentalsmexico.com.\n\nName: ${name}\nEmail: ${email}\nCity of interest: ${city}\nMessage: ${message}`
      : `Hola, vi su sitio, temporaryrentalsmexico.com.\n\nNombre: ${name}\nEmail: ${email}\nCiudad de interés: ${city}\nMensaje: ${message}`;
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl p-6" style={{ backgroundColor: 'var(--card)', border: '1px solid var(--border)' }}>
              ...
              <a href={`https://wa.me/525643232610?text=${encodeURIComponent(
                  lang === 'en'
                    ? "Hi, I saw your site, temporaryrentalsmexico.com, and I need help finding a property in Mexico."
                    : 'Hola, vi su sitio, temporaryrentalsmexico.com, y necesito ayuda para encontrar una propiedad en México.'
                )}`}
