...
export default function ContactPage() {
  ...
  const handleSubmit = () => {
    ...
    const text = `Hola, vi su sitio, temporaryrentalsmexico.com.\n\nNombre: ${name}\nEmail: ${email}\nCiudad de interés: ${city}\nMensaje: ${message}`;
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            {[
              { icon: '💬', title: 'WhatsApp', desc: 'Respuesta en minutos', value: '+52 56 4323 2610', href: 'https://wa.me/525643232610' },
            ...
            <div className="rounded-2xl p-6" style={{ backgroundColor: 'var(--card)', border: '1px solid var(--border)' }}>
              ...
              <a href="https://wa.me/525643232610?text=Hola%2C%20vi%20su%20sitio%2C%20temporaryrentalsmexico.com%2C%20y%20necesito%20ayuda%20para%20encontrar%20una%20propiedad%20en%20México."
